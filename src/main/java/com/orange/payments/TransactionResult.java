...
public class TransactionResult {
    ...
    public TransactionResult(String providerName, TransactionStatus status, double transactionFee,
        String resultMessage, Transaction transaction, double totalFee, double receiverWillGet,
    ...
    public String toString() {
        return "TransactionResult{" +
            ...
            ", totalFee=" + totalFee +
            ", receiverWillGet=" + receiverWillGet +
            ", forwardToProvider=" + forwardToProvider +
            '}';
    }
}
