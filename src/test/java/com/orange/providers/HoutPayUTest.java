...
public class HoutPayUTest {
  @InjectMocks private HoutPay houtPay;
  ...
  @Test
  public void
      givenCountryIsSouthAfrica_andCardTypeHoutPay_calculateTransactionFee_thenReturnTwenty()
  ...
  @Test
  public void
      givenCountryIsNotSouthAfrica_andCardTypeNotHoutPay_calculateTransactionFee_thenReturnTwenty()
          throws UnsupportedTransactionException {
