...
public class QuickPayUTest {
  ...
  @InjectMocks private QuickPay quickPay;
  ...
  public void givenCountryIsSouthAfrica_calculateTransactionFee_thenReturnUnsupportedTransactionException()
  ...
  @Test
  public void
      givenCountryIsNotIndia_andCardTypeIsDinners_calculateTransactionFee_thenReturnTwentyFive()
          throws UnsupportedTransactionException {
  ...
  @Test
  public void givenCountryIsIndia_andCardTypeIsDinners_calculateTransactionFee_thenReturnFour()
      throws UnsupportedTransactionException {
    when(transaction.getCountry()).thenReturn(Country.india());
  ...
  @Test
  public void givenCountry_andCardTypeNotDinners_calculateTransactionFee_thenReturnThree()
      throws UnsupportedTransactionException {
    when(transaction.getCountry()).thenReturn(Country.india());
    when(transaction.getTransactionAmount()).thenReturn(100);
  ...
  /**
   * * Test Scenario Amount = 100 * Transaction fee - $4 * Status - True (Success) * Amount -
   * receiverWillGet(95.5)
   */
  @Test
  public void givenValidTransaction_processTransaction_thenReturnTransactionResult()
      throws UnsupportedTransactionException {
    when(transaction.getCountry()).thenReturn(Country.india());
    when(transaction.getTransactionAmount()).thenReturn(100);
    when(transaction.getCardType()).thenReturn(CardType.DinersClub);
    ...
    assertEquals(4.0, transactionResult.getTransactionFee(), delta);
  ...
  @Test
  public void givenInvalidTransaction_processTransaction_thenReturnFail()
      throws UnsupportedTransactionException {
    when(transaction.getCountry()).thenReturn(Country.southAfrica());
    TransactionResult transactionResult = quickPay.processTransaction(transaction);
